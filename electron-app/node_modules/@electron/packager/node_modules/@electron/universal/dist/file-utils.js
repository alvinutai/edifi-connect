...
export async function compareDirectories(dir1, dir2) {
    async function getFiles(dir, rel = '') {
...
(function (AppFileType) {
    ...
    AppFileType[AppFileType["SINGLE_ARCH"] = 5] = "SINGLE_ARCH";
})(AppFileType || (AppFileType = {}));
const isSingleArchFile = (relativePath, opts) => {
 ...
 */
export const getAllAppFiles = async (appPath, opts) => {
...
export const fsMove = async (oldPath, newPath) => {
    try {
